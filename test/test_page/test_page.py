...
class TestFuzzyPageNames:
    def test_sanity(self):
        ...
        for page_name in ('diet', 'behavior', 'cognitive', 'mental'):
            assert function_page_with_no_return[page_name]
            assert function_page_with_no_return[page_name].read()
        assert function_page_with_no_return['cognitive'].read() == function_page_with_no_return['mental'].read()
