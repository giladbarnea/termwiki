...
class TestDirectory:
    class TestFunctionPage:
        def test_pages_adhd(self):
            ...
            adhd_page: FunctionPage = pages_page.search('adhd')
        ...
        def test_function_variable(self):
            adhd_path, adhd_page = page_tree.deep_search('adhd')
            diet_page: FunctionPage = adhd_page.search('diet')
        ...
        class TestPythonFile:
            class TestEponymousFunction:
                def test_pecan_product_product(self):
                    ...
                    product_page: PythonFilePage = pecan_page.search('product')
                    product_function_page: FunctionPage = product_page.search('product')
