...
class TestStyleDecorator:
    ...
    def test_language_style(self):
        pages = mock_page_tree["pages"]
        function_page_with_style_python_friendly_decorator = pages[
            "with_style_python_friendly_decorator"
        ]
        assert function_page_with_style_python_friendly_decorator
        function_page_with_style_python_friendly_decorator_text = (
            function_page_with_style_python_friendly_decorator.read()
        )
        assert (
            function_page_with_style_python_friendly_decorator_text
            == "with @style(python='friendly') decorator"
        )
