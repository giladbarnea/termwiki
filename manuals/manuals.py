...
def pytest(subject=None):
    ...
    """
    _HOOKS_OBJECTS = f"""{h4('Hooks Objects')}
      {c('https://docs.pytest.org/en/latest/reference/reference.html#objects')}
      %python
      BaseReport:
          ...
          longrepr?: ExceptionInfo | (str, int?, int) |  str | TerminalRepr
          sections: [(str, str)]
          nodeid: str
          *properties, methods...
      ...
      TestReport(BaseReport):
          ...
          sections: [(str, str)] = []
          duration: float = 0.0
          user_properties?: [(str, object)] = []
          keywords: {{ str: object }}
          
          @classmethod
          from_item_and_call(item, call) -> TestReport
    
      CollectReport(BaseReport):
          when: 'call' | 'setup' | 'teardown' = 'collect'
    ...
    {h4('Debugging / Interaction Hooks')}
      %python
      pytest_internalerror(excrepr, excinfo) -> bool?
...
def python(subject=None):
  ...
  {h4('See also')}
    ...
    {h3('Replacement Fields')}
      ...
      conversion        ::=  "r" | "s" | "a" {c("repr, str, ascii")}
    ...
    {h3('Examples')}
      "{{0.weight}}"      {c("'weight' attribute of first positional arg")}
  ...
  *emphasis*, **strong emphasis**, `interpreted text`, ``inline
  ...
  {h2('Examples')}
    ...
    .. code-block:: javascript
      :emphasize-lines: 8,10,16 {c('or :linenos:')}
...
def setuppy(subject=None):
  ...
  {c('https://docs.python.org/3/distutils/setupscript.html')}
  {c('https://setuptools.readthedocs.io/en/latest/setuptools.html#options')}
